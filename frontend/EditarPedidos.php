...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>EditarPedido - Coffee Luda</title>
                        ...
                        Producto: <?php echo $value['IdProducto']; ?>
                                ...
                                <div class="col-lg-4 wow "  data-wow-duration="700ms" data-wow-delay="300ms">
                                    <div class="contact_form">
                                        ...
                                        <input type="text" value="<?php echo $value['Cantidad']; ?>" placeholder="Cantidad" name="Cantidad" />
                                ...
                                <div class="col-lg-4 wow fadeIn"  data-wow-duration="700ms" data-wow-delay="300ms">
                                    <div class="contact_form">
                                        ...
                                        <input type="text" value="<?php echo $value['Total']; ?>"  placeholder="Total" name="Total" />
                                ...
                                <div class="col-lg-4 wow fadeIn"  data-wow-duration="700ms" data-wow-delay="300ms">
                                    <div class="contact_form">
                                        ...
                                        <input type="text" disabled value="<?php echo $value['Fecha']; ?>" placeholder="Fecha" name="Fecha" />
                                ...
                                <div class="col-lg-4 wow fadeIn"  data-wow-duration="700ms" data-wow-delay="300ms">
                                    <div class="contact_form">
                                        ...
                                        <input type="hidden" value="<?php echo $id ?>" placeholder="IdPedido" name="IdPedido" />
